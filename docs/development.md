...
2. `uv pip install typer-invoke && inv pip sync requirements-dev`
...
### Using invoke
After installing the dev requirements, try the commands below.
...
```
uv pip install typer-invoke && inv pip sync requirements-docs
```
